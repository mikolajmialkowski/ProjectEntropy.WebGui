...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './scheduler-settings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEDULERSETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHEDULERSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHEDULERSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHEDULERSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHEDULERSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHEDULERSETTINGS actions', async () => {
      const expectedActions = [
        {
