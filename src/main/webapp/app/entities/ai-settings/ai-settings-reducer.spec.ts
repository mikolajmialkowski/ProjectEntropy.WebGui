...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AISETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_AISETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AISETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AISETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AISETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AISETTINGS actions', async () => {
      const expectedActions = [
        {
