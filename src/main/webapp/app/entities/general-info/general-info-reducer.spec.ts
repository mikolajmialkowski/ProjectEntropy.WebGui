...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERALINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENERALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENERALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENERALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENERALINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENERALINFO actions', async () => {
      const expectedActions = [
        {
