...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREDICTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREDICTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREDICTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREDICTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREDICTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREDICTION actions', async () => {
      const expectedActions = [
        {
