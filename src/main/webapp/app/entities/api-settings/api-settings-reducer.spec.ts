...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APISETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APISETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APISETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APISETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APISETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APISETTINGS actions', async () => {
      const expectedActions = [
        {
