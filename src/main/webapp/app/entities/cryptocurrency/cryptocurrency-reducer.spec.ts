...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRYPTOCURRENCY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CRYPTOCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRYPTOCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRYPTOCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRYPTOCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRYPTOCURRENCY actions', async () => {
      const expectedActions = [
        {
