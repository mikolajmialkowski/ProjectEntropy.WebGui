...
public class Prediction implements Serializable {
    ...
    @Column(name = "predicted_praice")
    private String predictedPraice;
    ...
    public String getPredictedPraice() {
        return this.predictedPraice;
    }

    public Prediction predictedPraice(String predictedPraice) {
        this.setPredictedPraice(predictedPraice);
        return this;
    }

    public void setPredictedPraice(String predictedPraice) {
        this.predictedPraice = predictedPraice;
    }
    ...
    public String toString() {
        return "Prediction{" +
            ...
            ", predictedPraice='" + getPredictedPraice() + "'" +
