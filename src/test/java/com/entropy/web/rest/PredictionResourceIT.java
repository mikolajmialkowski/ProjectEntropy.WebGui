...
class PredictionResourceIT {
    ...
    private static final String DEFAULT_PREDICTED_PRAICE = "AAAAAAAAAA";
    private static final String UPDATED_PREDICTED_PRAICE = "BBBBBBBBBB";
    ...
    public static Prediction createEntity(EntityManager em) {
        Prediction prediction = new Prediction()
            ...
            .predictedPraice(DEFAULT_PREDICTED_PRAICE)
    ...
    public static Prediction createUpdatedEntity(EntityManager em) {
        Prediction prediction = new Prediction()
            ...
            .predictedPraice(UPDATED_PREDICTED_PRAICE)
    ...
    void createPrediction() throws Exception {
        ...
        assertThat(testPrediction.getPredictedPraice()).isEqualTo(DEFAULT_PREDICTED_PRAICE);
    ...
    void getAllPredictions() throws Exception {
        ...
        restPredictionMockMvc
            ...
            .andExpect(jsonPath("$.[*].predictedPraice").value(hasItem(DEFAULT_PREDICTED_PRAICE)))
    ...
    void getPrediction() throws Exception {
        ...
        restPredictionMockMvc
            ...
            .andExpect(jsonPath("$.predictedPraice").value(DEFAULT_PREDICTED_PRAICE))
    ...
    void putNewPrediction() throws Exception {
        ...
        assertThat(testPrediction.getPredictedPraice()).isEqualTo(UPDATED_PREDICTED_PRAICE);
